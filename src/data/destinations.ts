...
export const destinations: Destination[] = [
  {
    id: 'maryland',
    country: 'Maryland',
    name: 'Kerwood Greenway',
    routeLabel: 'Home Greenway',
    tagline: 'The home road bends toward the park.',
    overview: 'Kerwood bends toward MLK Park: path right, water and field lights left.',
    unlockHint: 'Start here.',
    run: {
      difficulty: 1,
      skillFocus: 'Home Greenway',
      finishDistance: 250,
      targetScore: 13,
      baseSpeed: 0.9,
      trailNote: 'Stay near the right path and grab Tandborste.',
      challengeSummary: 'Soft turns by the lake and fields.',
      challengeTips: ['Path right', 'Lake left', 'Field lights'],
    },
    recipe: {
      id: 'maryland-crab-cake',
      name: 'Maryland Picnic',
      country: 'Maryland',
      flavorText: "Packed for Chloe's home road.",
    },
    theme: {
      accent: '#1f9b6b',
      secondary: '#d3dee3',
  ...
  {
    id: 'moco-police-station',
    country: 'MoCo',
    name: 'MoCo Police Station',
    routeLabel: 'Station Loop',
    tagline: 'Crosswalks, cones, and a clean station sprint.',
    overview:
      'Milestone Drive bends past the station entrance: crosswalks, curb islands, and blue-red beacons.',
    unlockHint: 'Clear Home Greenway.',
    run: {
      difficulty: 2,
      skillFocus: 'Crosswalk Timing',
      finishDistance: 390,
      targetScore: 24,
      baseSpeed: 1.14,
      trailNote: 'Read the crosswalk stripes, hop cones, then shift around curb blocks.',
      challengeSummary: 'Station cones with a light lane rhythm.',
      challengeTips: ['Crosswalk stripes', 'Cone hops', 'Beacon rhythm'],
    },
    recipe: {
      id: 'moco-station-badge',
      name: 'Station Safety Badge',
      country: 'MoCo',
      flavorText: 'A bright badge card from the Milestone Drive station loop.',
    },
    theme: {
      accent: '#1f5fae',
      secondary: '#f6c84c',
      background: '#d7f0ea',
      backgroundAlt: '#8ac5a9',
      fog: '#b9e2d8',
      lightA: '#f9fff4',
      lightB: '#ffe39a',
      surface: '#68777a',
  ...
  },
  {
    ...
    unlockHint: 'Clear MoCo Police Station.',
    run: {
      difficulty: 3,
      skillFocus: 'Fast Mix',
      finishDistance: 460,
