...
export const destinations: Destination[] = [
  {
    ...
    tagline: 'Home route. Easy lanes by the bay.',
    overview: 'A gentle first run through boardwalk, marsh, and Chloe-color sunshine.',
    ...
    run: {
      ...
      targetScore: 13,
      baseSpeed: 0.9,
      trailNote: 'Easy boardwalk. Stay loose and grab Tandborste.',
      challengeSummary: 'Wide lanes. Gentle pace. Good warmup.',
      challengeTips: ['Easy lanes', 'Light blockers', 'Good warmup'],
    },
    recipe: {
      id: 'maryland-crab-cake',
      name: 'Crab Cake Picnic',
      country: 'Maryland',
      flavorText: "A little Maryland treat for Chloe's book.",
    },
    theme: {
      accent: '#00a982',
      secondary: '#ffbf32',
